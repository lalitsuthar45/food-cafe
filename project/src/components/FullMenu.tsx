...
export default function FullMenu({ cartItems, setCartItems }: FullMenuProps) {
  ...
  // All images below are hotlinked directly from Unsplash's CDN
  // (images.unsplash.com), using real, verified photo IDs matched to each
  // dish's category (burgers, pizzas, desserts, Indian curries, etc).
  const menu: FoodItem[] = [
  {
    id: 1,
    name: "Veg Burger",
    ...
    description: "Crispy vegetable patty layered with lettuce and mayo.",
    category: "Burger",
  },
  {
    id: 2,
    ...
    description: "Juicy grilled burger topped with melted cheddar cheese.",
    category: "Burger",
  },
  {
    id: 3,
    ...
    description: "Grilled chicken fillet burger with fresh vegetables.",
    category: "Burger",
  },
  {
    id: 4,
  ...
  },
  {
    ...
    description: "Spicy pepperoni slices loaded with cheese.",
    category: "Pizza",
  },
  {
    id: 7,
    ...
    description: "Veg pizza loaded with capsicum, onion and olives.",
    category: "Pizza",
  },
  {
    id: 8,
  ...
  },
  {
    ...
    description: "Spicy noodles cooked in schezwan sauce.",
    category: "Noodles",
  },
  {
    id: 11,
    ...
    price: 299,
    image: "https://images.unsplash.com/photo-1600490036275-35f5f1656861?auto=format&fit=crop&w=800&q=80",
    description: "Egg noodles mixed with tender chicken pieces.",
    category: "Noodles",
  },
  {
    id: 12,
  ...
  },
  {
    ...
    price: 189,
    image: "https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=800&q=80",
    description: "Crispy cauliflower florets in spicy gravy.",
    category: "Manchurian",
  },
  {
    id: 14,
    ...
    description: "Juicy chicken balls coated in flavorful sauce.",
    category: "Manchurian",
  },
  {
    id: 15,
  ...
  },
  {
    ...
    description: "Rich chocolate layered cake with smooth frosting.",
    category: "Dessert",
  },
  {
    id: 18,
    name: "Gulab Jamun",
    price: 149,
    image: "https://images.unsplash.com/photo-1568827999250-3f6afff96e66?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    price: 199,
    image: "https://images.unsplash.com/photo-1530648672449-81f6c723e2f1?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    description: "Grilled paneer patty burger with onion rings and mint mayo.",
    category: "Burger",
  },
  {
    id: 22,
    ...
    description: "Juicy mushroom patty topped with cheese and lettuce.",
    category: "Burger",
  },
  {
    id: 23,
    ...
    description: "Smoky BBQ glazed chicken fillet burger.",
    category: "Burger",
  },
  {
    id: 24,
    ...
    description: "Spicy Mexican style burger with jalapenos and salsa.",
    category: "Burger",
  },
  {
    id: 25,
    ...
    description: "Pizza loaded with molten cheese inside the crust.",
    category: "Pizza",
  },
  {
    id: 26,
    ...
    description: "Loaded with onion, capsicum, olives and mushrooms.",
    category: "Pizza",
  },
  {
    id: 27,
    ...
    description: "Tandoori chicken chunks with spicy Indian flavor.",
    category: "Pizza",
  },
  {
    id: 28,
  ...
  },
  {
    ...
    price: 229,
    image: "https://images.unsplash.com/photo-1612929633738-8fe44f7ec841?auto=format&fit=crop&w=800&q=80",
    description: "Stir fried rice mixed with vegetables and soy sauce.",
    category: "Chinese",
  },
  {
    id: 30,
    ...
    price: 269,
    image: "https://images.unsplash.com/photo-1585032226651-759b368d7246?auto=format&fit=crop&w=800&q=80",
    description: "Aromatic rice tossed with chicken pieces and spices.",
    category: "Chinese",
  },
  {
    id: 31,
    ...
    price: 249,
    image: "https://images.unsplash.com/photo-1600490036275-35f5f1656861?auto=format&fit=crop&w=800&q=80",
    description: "Spicy rice cooked in authentic schezwan sauce.",
    category: "Chinese",
  },
  {
    id: 32,
    name: "Spring Rolls",
    price: 179,
    image: "https://images.unsplash.com/photo-1598679253544-2c97992403ea?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    price: 329,
    image: "https://images.unsplash.com/photo-1633352615955-f0c99e8b7e5a?auto=format&fit=crop&w=800&q=80",
    description: "Crispy chicken pieces cooked with capsicum and sauce.",
    category: "Chinese",
  },
  {
    id: 35,
    ...
    description: "South Indian crispy dosa stuffed with potato masala.",
  ...
  },
  {
    ...
    name: "Idli Sambhar",
    price: 129,
    image: "https://images.unsplash.com/photo-1694849789325-914b71ab4075?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    name: "Vada Pav",
    price: 89,
    image: "https://images.unsplash.com/photo-1630431341973-02e1b662ec35?auto=format&fit=crop&w=800&q=80",
    description: "Mumbai style spicy potato fritter sandwich.",
    category: "Fast Food",
  },
  {
    id: 38,
    ...
    description: "Spicy mashed vegetable curry served with butter pav.",
    category: "Indian",
  },
  {
    id: 39,
  ...
  },
  {
    ...
    description: "Fresh strawberry blended milkshake with cream topping.",
    category: "Beverage",
  },
  {
    id: 41,
    ...
    description: "Fresh mango blended with chilled milk and ice cream.",
    category: "Beverage",
  },
  {
    id: 42,
    ...
    description: "Chilled coffee blended with milk and chocolate syrup.",
    category: "Beverage",
  },
  {
    id: 43,
  ...
  },
  {
    ...
    name: "Lemon Soda",
    price: 79,
    image: "https://images.unsplash.com/photo-1611928237590-087afc90c6fd?auto=format&fit=crop&w=800&q=80",
    description: "Refreshing lemon soda with a hint of mint.",
    category: "Beverage",
  },
  {
    id: 45,
    ...
    price: 349,
    image: "https://images.unsplash.com/photo-1728910156510-77488f19b152?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    description: "Tender chicken cooked in rich buttery tomato sauce.",
    category: "Indian",
  },
  {
    id: 47,
  ...
  },
  {
    ...
    name: "Tandoori Roti",
    price: 29,
    image: "https://images.unsplash.com/photo-1710091691780-c7eb0dc50cf8?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    name: "Butter Naan",
    price: 49,
    image: "https://images.unsplash.com/photo-1631292784640-2b24be784d5d?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    name: "Veg Sandwich",
    price: 129,
    image: "https://images.unsplash.com/photo-1615485290836-4ebcebf44aaf?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    description: "Toasted sandwich stuffed with melted cheese.",
    category: "Fast Food",
  },
  {
    id: 56,
    name: "Club Sandwich",
    price: 189,
    image: "https://images.unsplash.com/photo-1688978181542-87a886a16fbe?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    description: "Deep fried crispy snack filled with spicy lentils.",
    category: "Fast Food",
  },
  {
    id: 59,
    name: "Rasmalai",
    price: 149,
    image: "https://images.unsplash.com/photo-1660383534593-6b5221ab80d2?auto=format&fit=crop&w=800&q=80",
    description: "Soft cottage cheese balls soaked in sweetened milk.",
    category: "Dessert",
  },
  {
    id: 60,
    name: "Jalebi",
    price: 99,
    image: "https://images.unsplash.com/photo-1576618148423-df549bcb6972?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    name: "Gulab Jamun",
    price: 119,
    image: "https://images.unsplash.com/photo-1624000961428-eeece184988b?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    price: 179,
    image: "https://images.unsplash.com/photo-1525203135335-74d272fc8d9c?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    name: "Vanilla Ice Cream",
    price: 99,
    image: "https://images.unsplash.com/photo-1555050338-0abc773f7978?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    price: 109,
    image: "https://images.unsplash.com/photo-1575919361890-69028a013637?auto=format&fit=crop&w=800&q=80",
    description: "Smooth and creamy chocolate ice cream scoop.",
    category: "Dessert",
  },
  {
    id: 65,
    ...
    price: 109,
    image: "https://images.unsplash.com/photo-1615735486329-c61cd40bfcc6?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    name: "Paneer Tikka Pizza",
    price: 349,
    image: "https://images.unsplash.com/photo-1661081090290-9b66fd49d882?auto=format&fit=crop&w=800&q=80",
    description: "Pizza topped with spicy paneer tikka chunks.",
    category: "Fast Food",
  },
  {
    id: 68,
    name: "Cheese Burger",
    price: 189,
    image: "https://images.unsplash.com/photo-1605262157780-8910063b2bf9?auto=format&fit=crop&w=800&q=80",
    description: "Juicy burger loaded with melted cheese slice.",
    category: "Fast Food",
  },
  {
    id: 69,
    name: "Veg Momos",
    price: 129,
    image: "https://images.unsplash.com/photo-1630431341636-999a7e047f3b?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    name: "French Fries",
    price: 119,
    image: "https://images.unsplash.com/photo-1751560455942-f859f1215826?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    name: "Masala Chai",
    price: 49,
    image: "https://images.unsplash.com/photo-1594488506255-a8bbfdeedbaf?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    name: "Cappuccino",
    price: 149,
    image: "https://images.unsplash.com/photo-1568901839119-631418a3910d?auto=format&fit=crop&w=800&q=80",
    description: "Hot coffee topped with creamy milk foam.",
    category: "Beverage",
  },
  {
    id: 75,
    ...
    price: 89,
    image: "https://images.unsplash.com/photo-1619158403521-ed9795026d47?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    description: "Classic pizza loaded with fresh vegetables and mozzarella.",
    category: "Pizza",
  },
  {
    id: 77,
    ...
    description: "Fresh mushroom pizza with creamy mozzarella cheese.",
    category: "Pizza",
  },
  {
    id: 78,
    ...
    description: "Authentic Italian pizza with herbs and olive oil.",
    category: "Pizza",
  },
  {
    id: 79,
    ...
    description: "Sweet corn topped with extra cheese.",
    category: "Pizza",
  },
  {
    id: 80,
    ...
    description: "Spicy Mexican style pizza with jalapenos.",
    category: "Pizza",
  },
  {
    id: 81,
    ...
    price: 149,
    image: "https://images.unsplash.com/photo-1713330801172-03f8d1c0dde7?auto=format&fit=crop&w=800&q=80",
    description: "Veg patty with lettuce, tomato and cheese.",
    category: "Burger",
  },
  {
    id: 82,
    ...
    price: 239,
    image: "https://images.unsplash.com/photo-1530554764233-e79e16c91d08?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    description: "BBQ sauce with grilled patty and cheese.",
    category: "Burger",
  },
  {
    id: 84,
    ...
    description: "Paneer patty served with spicy mayo.",
    category: "Burger",
  },
  {
    id: 85,
  ...
  },
  {
    ...
    description: "Chinese noodles tossed with vegetables.",
    category: "Chinese",
  },
  {
    id: 87,
    name: "Garlic Noodles",
    price: 229,
    image: "https://images.unsplash.com/photo-1627900440398-5db32dba8db1?auto=format&fit=crop&w=800&q=80",
    description: "Garlic flavored stir fried noodles.",
    category: "Chinese",
  },
  {
    id: 88,
    name: "Paneer Chilli",
    price: 279,
    image: "https://images.unsplash.com/photo-1603661688298-870c8958ebf8?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    name: "Dragon Chicken",
    price: 349,
    image: "https://images.unsplash.com/photo-1684707878393-02606f779d7f?auto=format&fit=crop&w=800&q=80",
    description: "Hot and spicy dragon chicken.",
    category: "Chinese",
  },
  {
    id: 91,
  ...
  },
  {
    ...
    name: "Shahi Paneer",
    price: 329,
    image: "https://images.unsplash.com/photo-1627366422957-3efa9c6df0fc?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    description: "Complete Indian meal with multiple dishes.",
    category: "Indian",
  },
  {
    id: 95,
  ...
  },
  {
    ...
    price: 99,
    image: "https://images.unsplash.com/photo-1571328003758-4a3921661729?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    price: 109,
    image: "https://images.unsplash.com/photo-1641665271888-575e46923776?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    price: 169,
    image: "https://images.unsplash.com/photo-1624781740834-fbfbf5fd221a?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    name: "Mint Mojito",
    price: 139,
    image: "https://images.unsplash.com/photo-1619158401201-8fa932695178?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    description: "Lemon mint cooler with soda.",
    category: "Beverage",
  },
  {
    id: 101,
    ...
    price: 199,
    image: "https://images.unsplash.com/photo-1469533778471-92a68acc3633?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    price: 219,
    image: "https://images.unsplash.com/photo-1556953410-b77c8b035596?auto=format&fit=crop&w=800&q=80",
  ...
  },
  {
    ...
    price: 249,
    image: "https://images.unsplash.com/photo-1605807646983-377bc5a76493?auto=format&fit=crop&w=800&q=80",
    description: "Creamy baked cheesecake with rich flavor.",
    category: "Dessert",
  },
  ];
  ...
  const getRating = (id: number) => (4.4 + (id % 6) / 10).toFixed(1);
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center justify-between mb-5">
          <p className="text-gray-600 dark:text-gray-300 font-semibold">
            Showing <span className="text-orange-600 font-extrabold">{filteredMenu.length}</span> items
          </p>

          <div className="hidden sm:flex items-center gap-2 text-gray-500 dark:text-gray-300 text-sm">
            <ArrowUpDown size={16} />
            {sortBy === "default" ? "Recommended" : "Sorted"}
          </div>
        </div>
              ...
              >
                <div className="relative h-56 overflow-hidden bg-orange-100 dark:bg-slate-800">
                  <img
                    ...
                    loading="lazy"
                    onError={(e) => {
                      // Fallback if an individual photo ever 404s: a generic
                      // food photo so the card never shows a broken image icon.
                  ...
                  <button className="absolute top-4 right-4 w-10 h-10 rounded-full bg-white/90 dark:bg-slate-900/90 shadow flex items-center justify-center hover:scale-110 transition">
                  ...
                  <div className="mt-auto flex items-center gap-3">
                    <div className="flex items-center rounded-2xl bg-orange-50 dark:bg-slate-800 border border-orange-100 dark:border-slate-700">
                      <button
                        ...
                        className="w-10 h-10 flex items-center justify-center text-orange-600"
                      >
                        <Minus size={16} />
                      </button>
