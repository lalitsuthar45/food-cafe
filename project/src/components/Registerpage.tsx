...
function Registerpage() {
  ...
  // =====================================================
  // SAVE AUTHENTICATION
  // Ab AuthContext ke login() ko call karta hai, jo
  // currentUser state turant update kar deta hai — isliye
  // /home pe navigate karte hi ProtectedRoute ko pata
  // rehta hai ki user logged in hai.
  // =====================================================
